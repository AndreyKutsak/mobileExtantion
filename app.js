const storage = {
	...
	address: function (data) {
		...
		if (
			data.cell_capacity &&
			data.cell_capacity !== data.addresses[article].cell_capacity
		) {
		...
		if (
			...
			data.last_goods_count !== data.addresses[article].last_goods_count
		) {
		...
		if (
			data.is_ignored &&
			data.is_ignored !== data.addresses[article].is_ignored
		) {
